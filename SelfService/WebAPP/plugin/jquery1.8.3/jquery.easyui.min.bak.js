...
function _27d(_27e){
var opts=$.extend({},$.fn.window.defaults,{through:false,collapsible:false,minimizable:false,maximizable:false,shadow:false,draggable:false,resizable:false,closed:true,style:{left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop},onBeforeOpen:function(){
...
win.window("open");
if(opts.through && window.parent ){
	$("body",window.parent.document).append(win.closest(".window"));
	win.window("window").css(opts.style);
}
return win;
};
