...
var GLOBAL = {
    ...
    CLASSNAME :'mysqlsql',
    FILEDS:{
        '1':{'title':'*订单日期','id':'ss_extd_update','seq':'1'},
        '2':{'title':'订单状态','id':'ss_extd_type','seq':'2'},
        ...
        '12':{'title':'序号','id':'id','seq':'12'},
        '13':{'title':'姓名','id':'PatientName','seq':'13'}
    }
}
var selectRow;
$(function () {
...
function LoadDg(){
    var input = {};
    input['TradeCode'] = "queryExtdetialQrcode^"  + GLOBAL.MODULENAME + "^" + GLOBAL.CLASSNAME;
    $.each(GLOBAL.FILEDS,function(index,key){
    ...
    try{
        layui.use('table', function(){
            ...
            table.render({
                ...
                cols: [[ //表头
                    //{field: GLOBAL.FILEDS[12].id, title: GLOBAL.FILEDS[12].title,width:80},
                    {field: GLOBAL.FILEDS[13].id, title: GLOBAL.FILEDS[13].title,width:80},
                    {field: GLOBAL.FILEDS[1].id, title: GLOBAL.FILEDS[1].title,width:150},//,sort:true 排序
                    {field: GLOBAL.FILEDS[2].id, title: GLOBAL.FILEDS[2].title,width:90},
                    {field: GLOBAL.FILEDS[3].id, title: GLOBAL.FILEDS[3].title,width:90},
                    {field: GLOBAL.FILEDS[4].id, title: GLOBAL.FILEDS[4].title,width:90},
                    {field: GLOBAL.FILEDS[5].id, title: GLOBAL.FILEDS[5].title,width:200},
                    {field: GLOBAL.FILEDS[6].id, title: GLOBAL.FILEDS[6].title,width:240},
                    {field: GLOBAL.FILEDS[7].id, title: GLOBAL.FILEDS[7].title,width:220},
                    {field: GLOBAL.FILEDS[10].id, title: GLOBAL.FILEDS[10].title,width:80},
                    {field: GLOBAL.FILEDS[8].id, title: GLOBAL.FILEDS[8].title,width:200},
                    {field: GLOBAL.FILEDS[9].id, title: GLOBAL.FILEDS[9].title,width:200},
                ]]
            });
            //监听行单击事件
            table.on('row(dg)', function(obj){
                ...
                if(selectRow && selectRow.data.id == obj.data.id){ // 取消选中
                     ...
                     var formTable = $('.layui-form').find('input').not('#ss_extd_update').not('#QueryBtn').not('#ClearBtn');
                ...
                if (selectRow) {
                    ...
                    layui.use('form', function() {
                        var form = layui.form;
                        var formTable = $('.layui-form').find('select').not('#QueryBtn').not('#ClearBtn').not('#ss_extd_update');
                        $.each(formTable,function(index,select){
