 ...
 */
var GLOBAL = {
    MODULENAME : 'SelfServPy.Common.ss_eqroleCtl',
    CLASSNAME :'EROC',
    FILEDS:{
        '1':{'title':'角色代码','id':'ss_eqro_code','seq':'1'},
        '2':{'title':'角色名称','id':'ss_eqro_desc','seq':'2'}
    }
}
var selectRow;
$(function () {
        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                cols: [[ //表头
                    ...
                    {field: GLOBAL.FILEDS[2].id, title: GLOBAL.FILEDS[2].title,width:200},
