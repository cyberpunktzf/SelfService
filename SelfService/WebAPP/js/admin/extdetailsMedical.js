...
var GLOBAL = {
    ...
    FILEDS:{
        ...
        '2':{'title':'订单类型','id':'ss_extd_type','seq':'2'},
        '3':{'title':'交易渠道','id':'ss_extd_channel','seq':'3'},
        '4':{'title':'账户支付','id':'ss_extd_INSUZHZF','seq':'4'},
        ...
        '14':{'title':'统筹支付','id':'ss_extd_INSUTCZF','seq':'14'},
    }
}
var selectRow;
$(function () {
...
function LoadDg(){
    var input = {};
    input['TradeCode'] = "queryExtdetialMedical^"  + GLOBAL.MODULENAME + "^" + GLOBAL.CLASSNAME;
    $.each(GLOBAL.FILEDS,function(index,key){
        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                cols: [[ //表头
                    ...
                    {field: GLOBAL.FILEDS[14].id, title: GLOBAL.FILEDS[14].title,width:90},
                    {field: GLOBAL.FILEDS[5].id, title: GLOBAL.FILEDS[5].title,width:220},
                    {field: GLOBAL.FILEDS[10].id, title: GLOBAL.FILEDS[10].title,width:80},
                    {field: GLOBAL.FILEDS[8].id, title: GLOBAL.FILEDS[8].title,width:350},
                    {field: GLOBAL.FILEDS[9].id, title: GLOBAL.FILEDS[9].title,width:350},
                ]]
            });
            //监听行单击事件
