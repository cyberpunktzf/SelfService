...
var GLOBAL = {
    ...
    FILEDS:{
        ...
        '4':{'title':'值','id':'ss_pc_demo','seq':'4'},
        '5':{'title':'保存模式','id':'ss_pc_savemode','seq':'5'},
        '6':{'title':'保存值','id':'ss_pc_saveval','seq':'6'}
    }
}
var selectRow;
var table;
    ...
    try{
        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                cols: [[ //表头
                    {field: GLOBAL.FILEDS[1].id, title: GLOBAL.FILEDS[1].title,width:100,hide:true},
                    ...
                    {field: GLOBAL.FILEDS[4].id, title: GLOBAL.FILEDS[4].title,width:100,hide:true},
